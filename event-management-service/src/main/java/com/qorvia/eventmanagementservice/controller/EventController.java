...
//import com.qorvia.eventmanagementservice.service.SampleService;
...
//    private final SampleService sampleService;
    ...
    public ResponseEntity<?> getOnlineEventData(@PathVariable("id") String eventId){
        return eventService.getOnlineEventData(eventId);
    }

    @GetMapping("/getOfflineEventData/{id}")
    public ResponseEntity<?> getOfflineEventData(@PathVariable("id") String eventId){
        return eventService.getOfflineEventData(eventId);
    }
